...
/* 파일 문턱 7 → 8MB (§116). 7 은 §109 에서 잡은 어림수였고, UI 3단계 배너 시트에서
   처음 부딪혔다(6.90 → 7.17). 이 문턱이 지키는 것은 아티팩트 한계(16MB)와 첫 로드
   시간이다 — 둘 다 8 에서 여유가 있다. 대안(초상 68장만 손실 WebP 로 따로 싸기)은
   아틀라스가 둘이 되고 §109 의 자홍 테 위험이 있어 안 골랐다. 다음에 또 부딪히면
   그때는 문턱이 아니라 무엇을 덜 실을지를 본다. */
const MB = 1024 * 1024, BUDGET = 8 * MB, SIDE_MAX = 15600, WEBP_MAX = 16383;
